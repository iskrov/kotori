"""
Seed data for updated global share templates (English-only text).
"""

# 1) Regular Wellness Check
REGULAR_WELLNESS_TEMPLATE = {
...
# 2) Mood Tracking Summary
MOOD_TRACKING_TEMPLATE = {
...
# 3) Medical Visit Prep
MEDICAL_VISIT_PREP_TEMPLATE = {
...
# 4) Therapy Session Prep
THERAPY_SESSION_PREP_TEMPLATE = {
...
# 6) Online AI Advisor Upload
AI_ADVISOR_UPLOAD_TEMPLATE = {
