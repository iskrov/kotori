...
def upgrade() -> None:
    # Make this upgrade idempotent in case of partial runs in transactional DDL
    ...
    op.execute('DROP TABLE IF EXISTS alert_channels CASCADE')
    op.execute('DROP TABLE IF EXISTS monitoring_metrics CASCADE')
    op.execute('DROP TABLE IF EXISTS monitoring_dashboards CASCADE')
    op.execute('DROP TABLE IF EXISTS monitoring_configuration CASCADE')
    op.execute('DROP TABLE IF EXISTS system_health CASCADE')
    op.execute('DROP TABLE IF EXISTS service_health CASCADE')
    op.execute('DROP TABLE IF EXISTS migration_log CASCADE')
    ...
    # Safe drop for optional legacy table
    op.execute('DROP TABLE IF EXISTS migration_log CASCADE')
